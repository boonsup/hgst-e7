...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/su3_beta_dependence}
...
$1/L$ extrapolations:
\begin{gather*}
  R_\infty^{\text{quark}} = 0.4981 \pm 0.0017(\text{stat}) \pm 0.0054(\text{syst}), \\
...
The SM extrapolation $R_\infty^\text{quark}\approx0.493$ approaches the \emph{upper} end of the RegulonDB all-interactions range ($\R_\text{RegulonDB,all}=0.413\pm0.012$).
...
\begin{enumerate}
  ...
  \item \textbf{Frustration ordering:}
        \begin{gather*}
          ...
          \lesssim\; \SU{3}\;(R_\infty=0.3539\pm0.0195) \;<\; \SM\;(R_\infty^q\approx0.493).
        \end{gather*}
...
The version corresponding to this publication is archived on Zenodo:
\href{https://doi.org/10.5281/zenodo.12345678}{doi:10.5281/zenodo.12345678}.
JSON data are in the \texttt{data/} directory.
Instructions for reproduction are in \texttt{README.md}.

\bibliographystyle{plainnat}
\bibliography{Empirical_Study}
