...
\author{%
  Author 1 and Author 2\\[4pt]
  \small\textit{Mathematics and Computational Physics Group}\\
...
The choice of $1/L^2$ scaling vs.\ the $1/L$ used in previous reports reflects a re-analysis
of the high-precision $L=10$ point, which indicates a stronger curvature in the scaling
behaviour as the thermodynamic limit is approached.
...
is archived on Zenodo at \href{https://doi.org/10.5281/zenodo.18873889}{doi:10.5281/zenodo.18873889}.
The production JSON data files referenced throughout this study are located
in the \texttt{data/} directory of the repository.
